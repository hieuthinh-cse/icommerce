...
public class AuthTokenFilter extends OncePerRequestFilter {
  ...
  private final JwtTokenCryptoEngine jwtTokenCryptoEngine;

  public AuthTokenFilter(JwtTokenCryptoEngine jwtTokenCryptoEngine) {
    this.jwtTokenCryptoEngine = jwtTokenCryptoEngine;
  }
  ...
  protected void doFilterInternal(
    ...
    try {
      var token = jwtTokenCryptoEngine
          .verifyBuyerToken(request.getHeader(AUTHORIZATION).substring(BEARER_SCHEME.length()));
